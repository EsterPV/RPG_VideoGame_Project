...
public class Proyectil : MonoBehaviour
{
    ...
    public void IniciarProyectil(PersonajeAtaque ataque)
    {
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            float danho = PersonajeAtaque.ObtenerDanho();
            EnemigoVida enemigoVida = enemigoObjetivo.GetComponent<EnemigoVida>();
            enemigoVida.recibirDaño(danho);
            PersonajeAtaque.EventoEnemigoDanhado?.Invoke(danho, enemigoVida);
